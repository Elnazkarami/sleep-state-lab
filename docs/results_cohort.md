...
Generated from `predictions_cohort.csv` (894905 saved prediction rows), split part `test`.
...
| D1-pretrained | 0.673 ± 0.106 | 0.712 | 0.746 | 0.758 | 0.879 | 81355 | 15 |
...
| D1-probe-pretrained | 0.537 ± 0.099 | 0.566 | 0.620 | 0.608 | 0.800 | 81355 | 15 |
| D1-probe-random | 0.291 ± 0.040 | 0.303 | 0.350 | 0.213 | 0.521 | 81355 | 15 |

## Per participant (primary metric)

| participant | D1 | D1+smoothing | D1-pretrained | D1-probe-pretrained | D1-probe-random | D2 | D2-context-masked | D2-shuffled-context | D3 | D3-context-masked | D3-shuffled-context |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| SC400 | 0.775 | 0.787 | 0.793 | 0.610 | 0.365 | 0.829 | 0.749 | 0.803 | 0.805 | 0.735 | 0.797 |
| SC403 | 0.805 | 0.817 | 0.777 | 0.608 | 0.257 | 0.824 | 0.762 | 0.797 | 0.789 | 0.761 | 0.767 |
| SC407 | 0.831 | 0.829 | 0.842 | 0.666 | 0.366 | 0.868 | 0.821 | 0.849 | 0.858 | 0.833 | 0.848 |
| SC425 | 0.565 | 0.566 | 0.588 | 0.320 | 0.245 | 0.659 | 0.572 | 0.640 | 0.647 | 0.626 | 0.633 |
| SC428 | 0.721 | 0.705 | 0.752 | 0.565 | 0.342 | 0.796 | 0.751 | 0.788 | 0.761 | 0.735 | 0.758 |
| SC429 | 0.780 | 0.745 | 0.804 | 0.645 | 0.314 | 0.823 | 0.750 | 0.797 | 0.796 | 0.774 | 0.773 |
| SC430 | 0.585 | 0.539 | 0.595 | 0.520 | 0.290 | 0.613 | 0.531 | 0.584 | 0.575 | 0.533 | 0.557 |
| SC431 | 0.733 | 0.702 | 0.739 | 0.650 | 0.315 | 0.776 | 0.700 | 0.748 | 0.735 | 0.700 | 0.733 |
| SC434 | 0.591 | 0.535 | 0.630 | 0.496 | 0.297 | 0.667 | 0.591 | 0.647 | 0.655 | 0.606 | 0.647 |
| SC443 | 0.718 | 0.636 | 0.725 | 0.599 | 0.263 | 0.777 | 0.700 | 0.769 | 0.732 | 0.696 | 0.715 |
| SC455 | 0.664 | 0.632 | 0.660 | 0.538 | 0.256 | 0.714 | 0.641 | 0.694 | 0.658 | 0.620 | 0.653 |
| SC459 | 0.659 | 0.692 | 0.623 | 0.530 | 0.277 | 0.685 | 0.591 | 0.660 | 0.687 | 0.620 | 0.674 |
| SC461 | 0.552 | 0.516 | 0.498 | 0.401 | 0.265 | 0.561 | 0.520 | 0.551 | 0.568 | 0.530 | 0.558 |
| SC473 | 0.524 | 0.580 | 0.539 | 0.390 | 0.270 | 0.607 | 0.447 | 0.589 | 0.630 | 0.483 | 0.609 |
| SC476 | 0.597 | 0.545 | 0.536 | 0.515 | 0.244 | 0.637 | 0.569 | 0.616 | 0.533 | 0.525 | 0.529 |
...
Run `cohort_d1_pretrained`, split `2a0313adb97b9da0`, seed 0. Quality-control coverage 1.000 (21 flagged epochs of 81355).

### Per stage

| stage | precision | recall | F1 (pooled) | F1 (participant mean) | support | participants |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Wake | 0.993 | 0.948 | 0.970 | 0.969 | 56983 | 15 |
| N1 | 0.292 | 0.577 | 0.388 | 0.390 | 3556 | 15 |
| N2 | 0.814 | 0.784 | 0.799 | 0.793 | 12477 | 15 |
| N3 | 0.662 | 0.824 | 0.734 | 0.558 | 2892 | 15 |
| REM | 0.759 | 0.596 | 0.668 | 0.656 | 5447 | 15 |

### Confusion matrix

| true \ predicted | Wake | N1 | N2 | N3 | REM |
| --- | ---: | ---: | ---: | ---: | ---: |
| Wake | 54047 | 2590 | 106 | 26 | 214 |
| N1 | 223 | 2053 | 806 | 65 | 409 |
| N2 | 70 | 1346 | 9783 | 872 | 406 |
| N3 | 0 | 23 | 486 | 2382 | 1 |
| REM | 86 | 1025 | 834 | 254 | 3248 |
...
Run `cohort_d1_probe_pre`, split `2a0313adb97b9da0`, seed 0. Quality-control coverage 1.000 (21 flagged epochs of 81355).

### Per stage

| stage | precision | recall | F1 (pooled) | F1 (participant mean) | support | participants |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Wake | 0.977 | 0.918 | 0.947 | 0.945 | 56983 | 15 |
| N1 | 0.182 | 0.423 | 0.254 | 0.249 | 3556 | 15 |
| N2 | 0.726 | 0.543 | 0.621 | 0.618 | 12477 | 15 |
| N3 | 0.512 | 0.843 | 0.637 | 0.510 | 2892 | 15 |
| REM | 0.374 | 0.372 | 0.373 | 0.362 | 5447 | 15 |

### Confusion matrix

| true \ predicted | Wake | N1 | N2 | N3 | REM |
| --- | ---: | ---: | ---: | ---: | ---: |
| Wake | 52338 | 3205 | 169 | 49 | 1222 |
| N1 | 382 | 1504 | 793 | 60 | 817 |
| N2 | 572 | 1777 | 6778 | 2030 | 1320 |
| N3 | 25 | 29 | 377 | 2437 | 24 |
| REM | 265 | 1750 | 1224 | 184 | 2024 |

## D1-probe-random

Run `cohort_d1_probe_rand`, split `2a0313adb97b9da0`, seed 0. Quality-control coverage 1.000 (21 flagged epochs of 81355).

### Per stage

| stage | precision | recall | F1 (pooled) | F1 (participant mean) | support | participants |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Wake | 0.860 | 0.605 | 0.710 | 0.707 | 56983 | 15 |
| N1 | 0.077 | 0.343 | 0.126 | 0.124 | 3556 | 15 |
| N2 | 0.314 | 0.432 | 0.364 | 0.360 | 12477 | 15 |
| N3 | 0.181 | 0.299 | 0.226 | 0.176 | 2892 | 15 |
| REM | 0.110 | 0.071 | 0.087 | 0.087 | 5447 | 15 |

### Confusion matrix

| true \ predicted | Wake | N1 | N2 | N3 | REM |
| --- | ---: | ---: | ---: | ---: | ---: |
| Wake | 34478 | 9511 | 8507 | 2341 | 2146 |
| N1 | 868 | 1221 | 1044 | 196 | 227 |
| N2 | 2427 | 2973 | 5393 | 987 | 697 |
| N3 | 766 | 447 | 731 | 866 | 82 |
| REM | 1548 | 1638 | 1477 | 395 | 389 |
